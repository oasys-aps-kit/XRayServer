...
# http://x-server.gmca.aps.anl.gov/cgi/WWW_form.exe?template=TER_sl_multilay.htm&method=post
#
...
### General parameters:
  ...
  $FORM{'comment1'} = 'Template: script getTER_query_post';
...
### Standing waves request:
  $FORM{'swflag'}   = 0;		# 0=do not print standing waves; 1=print
